# Change Map - As Wealth Manager, I want to perform real-time data retrieval of portfolio holdings to achieve up-to-date insights for my clients
...
- Feature slug: `real-time-portfolio-holdings-retrieval`
...
- `specs/.devx/change-maps/real-time-portfolio-holdings-retrieval.md`
- `specs/.devx/guidance/golden-repo-guidelines.md`
- `specs/real-time-portfolio-holdings-retrieval/specs.md`
- `specs/real-time-portfolio-holdings-retrieval/requirements.md`
- `specs/real-time-portfolio-holdings-retrieval/prompt.md`
